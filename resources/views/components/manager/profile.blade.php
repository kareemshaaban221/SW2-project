    ...
    <div class="card-body">
        <div class="m-auto">
            ...
            <div class="row mb-3 mt-3 justify-content-around">
                ...
                <div class="col-5 overflow-auto" style="height: 25px; text-align: left;">{{$user->manager->national_id}}</div>
            </div>
            <hr class="w-50 m-auto">
            <div class="row mb-3 mt-3 justify-content-around">
                <div class="col-5 text-primary" style="font-weight: bold; text-align: right;">Salary</div>
                <div class="col-5 overflow-auto" style="height: 25px; text-align: left;">{{$user->manager->salary ? $user->manager->salary : 'No Salary Specified'}}</div>
            </div>

            <div class="col-lg-3 col-md-5 col-sm-7 m-auto row mb-3 mt-3 justify-content-around">
                <a href="{{route('managers.index')}}" class="btn btn-outline-dark col-5">
                    <i class="fa fa-users"></i>
                    List
                </a>
                <a href="{{route('managers.edit', $user->username)}}" class="btn btn-outline-primary col-5">
