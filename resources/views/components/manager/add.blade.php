@extends('layouts.form-layouts', ['title' => 'add manager'])

@section('content')

@if (Session::has('exists'))
<form action="{{ route('managers.create.exists') }}" method="POST" class="d-none">
    @csrf
...
<div class="card-header ">
    <h3 class="text-center font-weight-light my-4">Add Manager</h3>
</div>
<div class="card-body ">
    @if (Session::has('err'))
