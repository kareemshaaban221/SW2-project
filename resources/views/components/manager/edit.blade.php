...
@section('content')
<div class="card-header "><h3 class="text-center font-weight-light my-4">Manager | {{$user->fname.' '.$user->lname}}</h3></div>
<div class="card-body ">
    @if (Session::has('err'))
    ...
    <form method="POST" action="{{ route('managers.update', $user->id) }}">
        ...
        <div class="form-floating mb-3 ">
            <input class="form-control" id="inputNationalID" name="national_id" type="text" placeholder="National ID"
                value="{{old('national_id') ? old('national_id') : $user->manager->national_id}}" />
        ...
        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
            <a class="btn btn-outline-dark col-lg-2 col-md-2" href="{{route('managers.show', $user->username)}}">
