@extends('layouts.form-layouts', ['title' => 'add receptionist'])

@section('content')

<div class="card-header ">
    <h3 class="text-center font-weight-light my-4">Add Receptionist</h3>
</div>
<div class="card-body ">
    @if (Session::has('err'))
    ...
    <form method="POST" action="{{ route('receptionists.store') }}">
        ...
        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
            ...
            <a class="btn btn-outline-dark" type="submit" href="{{route('receptionists.index')}}">
